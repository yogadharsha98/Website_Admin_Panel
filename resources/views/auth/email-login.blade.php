            ...
            <div class="container">
                <div class="categories-main">
                    <div class="row align-items-start"> <!-- Changed align-items-end to align-items-start -->
                        ...
                        <div class="col-lg-6">
                            <div class="categories-right">
                                <label class="mb-1">Login If you have an Account already</label>
                                <form action="{{ route('mail.login.submit') }}" method="POST">
                                    @csrf
                                    <div class="flex flex-col mb-4"> <!-- Changed this to flex-col to stack items -->
                                        ...
                                        <button type="submit" class="send-otp-button border rounded-md p-2">Login
                                        </button>
                                    </div>
                                    <h4>Forgot Password ?</h4>
                                </form>
                                <a href="{{ route('mail.register') }}">
                                    <button class="gmail-button border rounded-md p-2 mb-2 w-full flex items-center justify-center">
